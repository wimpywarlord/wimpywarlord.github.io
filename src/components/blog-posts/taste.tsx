    ...
    <div className="prose prose-sm sm:prose-base lg:prose-lg dark:prose-invert max-w-none">
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source
            src="/blog/taste/compressed_hero_video.mp4"
            type="video/mp4"
          />
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source
            src="/blog/taste/cleanshot_2026_08_23.mp4"
            type="video/mp4"
          />
          Your browser does not support the video tag.
        </GalleryVideo>
  ...
  \`translate(\${translateX}px, \${translateY}px) scale(\${scale})\`
      ...
      <p className="mt-4">
        <a
          ...
          className="text-primary hover:text-primary/80 underline underline-offset-2"
        >
          Cheng Lou — The future of text layout is not CSS
        </a>
      </p>
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/shader_orb_webgl.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      <p className="mt-4">
        <a
          href="https://playground.davidumoru.me/experiments/shader-orb"
          target="_blank"
          rel="noopener noreferrer"
          className="text-primary hover:text-primary/80 underline underline-offset-2"
        >
          David Umoru - Shader Orb Experiment
        </a>
      </p>
      ...
      <p className="mt-4">
        <a
          ...
          className="text-primary hover:text-primary/80 underline underline-offset-2"
        >
          Fuma Nama - SVG Art & Fumadocs TOC
        </a>
      </p>
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/scratch_to_reveal_interaction.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/pixelating_logo_carousel_css.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/claude_output_demo.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/css_scroll_snapping.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/emilkowalski_inspired_vibe_code.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/clean_animations.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/draggable_3d_gallery.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/visual_direction_project.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/webgl_carousel.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/lens_refraction_smooth_scroll.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/github_widget.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/oriku_video.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      <p className="mt-4">
        <a
          href="https://x.com/Oriku175/status/2065701075202806030"
          target="_blank"
          rel="noopener noreferrer"
          className="text-primary hover:text-primary/80 underline underline-offset-2"
        >
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/scanning_detecting_finding.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      <p className="mt-4">
        <a
          href="https://x.com/ayushsoni_io/status/2087250942366539989"
          target="_blank"
          rel="noopener noreferrer"
          className="text-primary hover:text-primary/80 underline underline-offset-2"
        >
      ...
      <div className="my-6">
        <GalleryVideo className="w-full max-w-2xl rounded-lg mx-auto">
          <source src="/blog/taste/hyperframes_carousel_blocks.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </GalleryVideo>
      </div>
      <p className="mt-4">
        <a
          href="https://hyperframes.heygen.com/catalog"
          target="_blank"
          rel="noopener noreferrer"
          className="text-primary hover:text-primary/80 underline underline-offset-2"
        >
        ...
        {" — 25 new carousel blocks in the catalog ("}
        <a
          href="https://x.com/Miguel07Code/status/2098527121702309905"
          target="_blank"
          rel="noopener noreferrer"
          className="text-primary hover:text-primary/80 underline underline-offset-2"
        >
